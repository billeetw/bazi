 ...
 * 共用模組：供 functions/api/me/estimate-hour 與 js/identifyBirthTime（前端 fallback）使用。
 *
 * @param {Object} answers - q1,q2 為 string[]（最多 2 項），其餘為 string
 * @param {Object} [options] - recentPredictions: [{bestBranch}] 或 getRecentPredictions: async (userId)=>[]
