/**
 * functions/logic/strategyEngine.js
 * 戰略文案庫（與 server/logic/strategyEngine.js 同步），僅供 API 使用，不得暴露至前端。
 */

const STRENGTH = {
  命宮: { 4: "系統效能全開。這局你是主角，世界會繞著你的意志轉動。", 3: "狀態良好。你的主觀意願能有效轉化為行動。", 2: "系統有些遲滯。你需要更多外部刺激才能啟動自己。", 1: "偵測到核心內耗。這局你容易自我懷疑，練習「看見自己」是首要任務。" },
  兄弟: { 4: "盟友極其強大。這是打團戰的最佳時機，眾人拾柴火焰高。", 3: "夥伴關係穩定。適合與人協作，能產生 1+1>2 的效果。", 2: "隊友幫不上忙。建議維持禮貌距離，重心回歸自己。", 1: "盟友區能量低迷。這局沒人能幫你，靠自己最踏實。" },
  夫妻: { 4: "感情能量充沛。伴侶能成為你最強的後盾與靈魂夥伴。", 3: "關係和諧。這是一個可以讓你安心修整的避風港。", 2: "互動有些吃力。需要花更多心力去校對彼此的需求。", 1: "此處能量乾涸。別把安全感寄託在他人身上，先愛回自己。" },
  子女: { 4: "產出效率極高。無論是作品、投資或下屬，都能帶來驚喜回報。", 3: "養成體系健全。你的投入會按部就班地開花結果。", 2: "產出不如預期。建議先優化流程，不要急著擴大投資。", 1: "這裡容易損耗精力。對外擴張要極度謹慎，守住現有成果。" },
  財帛: { 4: "提款路徑極短。只要你出手，財富轉換效率驚人。", 3: "現金流運轉良好。這是一個適合累積資產的平穩期。", 2: "投入多、回報少。這局你要練的是「精準」，而非「勤奮」。", 1: "此處地形崎嶇。容易發生意外支出，請開啟防禦模式。" },
  疾厄: { 4: "硬體素質極強。你可以承受高強度的運作而不會崩潰。", 3: "體能穩定。只要按時保養，就能支撐你的野心。", 2: "零件開始磨損。請注意身體發出的微小信號，別硬撐。", 1: "硬體嚴重過載。系統隨時可能當機，請優先回血。" },
  遷移: { 4: "世界對你敞開。出門就是主場，你的影響力能擴及遠方。", 3: "外部機會多。多出門走走，資源都在家門口之外。", 2: "外界阻力較大。環境不友善，建議回歸舒適圈作業。", 1: "外部能量混亂。此時不宜變動環境，守在原地最安全。" },
  僕役: { 4: "群眾能量極強。你擁有強大的社群吸附力，適合一呼百應。", 3: "社群關係健康。朋友與粉絲能為你的戰略加分。", 2: "應酬多但無益。請過濾無效社交，保護你的能量。", 1: "容易被誤解或孤立。這局不求人知，專注修煉內功。" },
  官祿: { 4: "事業如日中天。這是你的高光時刻，請把握機會擴張版圖。", 3: "發展路徑清晰。只要持續投入，就能穩定攀升等級。", 2: "升級路徑受阻。這局適合進修增能，而非盲目跳槽。", 1: "舞台能量微弱。你在這感到懷才不遇，需要重新定位。" },
  田宅: { 4: "存檔點極其穩固。你的家產與房產是這局最強的護城河。", 3: "內部環境安定。資產正處於良性累積的過程中。", 2: "家庭或資產不穩。建議優先整理內務，不要急著對外。", 1: "存檔點受損。這是你最脆弱的地方，請花時間修補根基。" },
  福德: { 4: "心態無敵。你具備極強的抗壓性與靈感，能從容面對一切。", 3: "精神狀態健康。你懂得如何讓自己開心，情緒穩定。", 2: "內心戲太多。你的精神內耗正在吃掉你的實戰能量。", 1: "負面情緒超載。這是這局最難的副本，請尋求外部引導。" },
  父母: { 4: "系統權限全開。長輩與體制會主動為你開路，盡情利用資源。", 3: "適合在體制內發展。只要守規矩，系統就會給你回報。", 2: "感覺被規則束縛。與權威溝通不順，請耐心磨合。", 1: "容易挑戰規則而受損。別硬碰體制，學會迂迴通關。" },
};
